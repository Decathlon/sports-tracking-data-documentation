...
`GET https://api-global.decathlon.net/sportstrackingdata/v2/datatypes/181`
...
`POST https://api-global.decathlon.net/sportstrackingdata/v2/user_measures`
...
```shell
curl -X POST \
    https://api-global.decathlon.net/sportstrackingdata/v2/user_measures \
...
```shell
curl -X GET \
    https://api-global.decathlon.net/sportstrackingdata/v2/user_measures?datatype=181 \
  -H 'Authorization: Bearer {your bearer}' \
  -H 'Content-Type: application/json' \
  -H 'x-api-key: {your api key}' 
```
