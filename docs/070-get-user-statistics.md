...
` GET https://api-global.decathlon.net/sportstrackingdata/v2/user_sumups`
...
```shell
curl -X GET \
    https://api-global.decathlon.net/sportstrackingdata/v2/user_sumups?period=2018&sport=121 \
